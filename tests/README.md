...
limit, a scaling law, or an independent integrator) — never "runs / finite /
positive".
...
|---|---|---|---|
| `test_kernels_rd.py` | RD transfer function `I_sq_RD`; non-negativity, k-independence | textbook `overline{I^2}(u,v)` (numpy) | rtol 1e-10 |
